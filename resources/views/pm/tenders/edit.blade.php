@extends('layouts.master', ['title' => 'ویرایش مناقصه'])
@section('content')
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">بروزرسانی مناقصه</span>
            </div>
                        ...
                        <form style="vertical-align:center;text-align:center" method="post" action="{{ route('tenders.update', $tender->id) }}" class="form form-horizontal form-bordered striped-rows">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="name">موضوع مناقصه</label>
                                    <div class="col-md-9">
