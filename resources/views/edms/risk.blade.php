@extends('layouts.master', ['title' => 'EDMS -> Risk'])
@section('content')
    <style>
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">EDMS -> Risk</span>
            </div>
    ...
    <div style="" class="kt-container  kt-grid__item kt-grid__item--fluid">
            ...
            <div class="col">
                <div class="alert alert-light alert-elevate fade show" role="alert">
                    ...
                    <div class="alert-text">
                        در این قسمت اطلاعات و داکیومنت های Riskineering نرم افزار EDMS قابل مشاهده میباشد. شایان ذکر است بروزرسانی این سیستم از طریق پنل مدیریت و مطابق با سطوح دسترسی تعریف شده قابل انجام است.
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="height: 900px;">
            ...
            <iframe style="width: 100%; height: 600px;" src="/edms/14-risk/index.html" frameborder="0"></iframe>
