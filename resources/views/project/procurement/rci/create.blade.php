@extends('layouts.master', ['title' => 'بارگزاری فایل درخواست های خرید'])
@section('content')
    <style>
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">بارگزاری فایل درخواست های خرید</span>
            </div>
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('rci.store') }}" method="POST" enctype="multipart/form-data" class="kt-form kt-form--label-right">
                                <div style="padding-left: 1%; padding-right: 1%;" class="kt-portlet__body">
                                    ...
                                    <div style=";color: #155724;background-color: #d4edda; border-color: #c3e6cb;" id="edu" class="alert alert-success" role="alert">
                                        ...
                                        <ul style="margin-top: 50px;margin-right: -100px;">
                                            <li style="padding: 5px">سطر هایی که عنوان ندارند، خالی و تستی وارد شده اند حذف شوند.</li>
                                            <li style="padding: 5px">نوع فیلد های تاریخ باید Short Date وارد شود </li>
                                            <li style="padding: 5px">نوع فیلد های تاریخ درصورتی که خالی است باید خالی وارد شود. </li>
                                            <li style="padding: 5px">فرمت فایل میبایست XLSX باشد </li>
                                            <a href="/dataEntry/examples/rci.xlsx"><li style="padding: 15px">دریافت نمونه فایل </li></a>
                                        </ul>
                                    ...
                                    <div style="direction: rtl" class="table-responsive">
                                        <table class="table table-striped table-hover table-condensed table-bordered">
                                            ...
                                            <tr>
                                                <td>انتخاب فایل درخواست های خرید</td>
                                                <td><input style="width: 200px" type="file" name="rci" value="{{ old('rci') }}" class="form-control"></td>
                                            </tr>
